...
import com.example.myapplication.firebase.FirestoreUtil;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirestoreUtil.getDatabaseInstance();
        init();
        loadUserDetails();
        getToken();
        setListeners();
    ...
    private void setListeners() {
        ...
        binding.imageProfile.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), UserProfileActivity.class)));
    }
